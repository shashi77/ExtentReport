...
public class BasicExtentReport {
 ...
 @Parameters({ "OS", "browser" })
    ...
    public void startReport(String OS, String browser) {
        ...
        htmlReporter = new ExtentHtmlReporter("C:\\Users\\vmware\\ToCreateExtentReport\\testReport.html");
...
//        extent.setSystemInfo("Browser", browser);
    ...
    public void testCase4() {
        test = extent.createTest("Test Case 4", "PASSED");
        Assert.fail();
    }

    @Test
    public void testCase5() {
        test = extent.createTest("Test Case 5", "SKIPPED");
